...
func (_m *MockContext) IntegrationDriver() types.IntegrationDriver {
	ret := _m.ctrl.Call(_m, "IntegrationDriver")
	ret0, _ := ret[0].(types.IntegrationDriver)
	return ret0
}

func (_mr *_MockContextRecorder) IntegrationDriver() *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "IntegrationDriver")
}
...
func (_m *MockContext) OSDriver() types.OSDriver {
	ret := _m.ctrl.Call(_m, "OSDriver")
	ret0, _ := ret[0].(types.OSDriver)
	return ret0
}

func (_mr *_MockContextRecorder) OSDriver() *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "OSDriver")
}
...
func (_m *MockContext) StorageDriver() types.StorageDriver {
	ret := _m.ctrl.Call(_m, "StorageDriver")
	ret0, _ := ret[0].(types.StorageDriver)
	return ret0
}

func (_mr *_MockContextRecorder) StorageDriver() *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "StorageDriver")
}
...
func (_m *MockContext) WithIntegrationDriver(_param0 types.IntegrationDriver) types.Context {
	ret := _m.ctrl.Call(_m, "WithIntegrationDriver", _param0)
	ret0, _ := ret[0].(types.Context)
	return ret0
}

func (_mr *_MockContextRecorder) WithIntegrationDriver(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "WithIntegrationDriver", arg0)
}
...
func (_m *MockContext) WithOSDriver(_param0 types.OSDriver) types.Context {
	ret := _m.ctrl.Call(_m, "WithOSDriver", _param0)
	ret0, _ := ret[0].(types.Context)
	return ret0
}

func (_mr *_MockContextRecorder) WithOSDriver(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "WithOSDriver", arg0)
}
...
func (_m *MockContext) WithStorageDriver(_param0 types.StorageDriver) types.Context {
	ret := _m.ctrl.Call(_m, "WithStorageDriver", _param0)
	ret0, _ := ret[0].(types.Context)
	return ret0
}

func (_mr *_MockContextRecorder) WithStorageDriver(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "WithStorageDriver", arg0)
}
